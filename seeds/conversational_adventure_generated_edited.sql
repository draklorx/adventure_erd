...
/* deleting all adventures should cascade and delte all other records */
delete from Adventure where id < 1000;
...
INSERT INTO Location
        (adventure_id, name, description,
         map_width, map_height, map_url, sort_order)
VALUES  (@adventure_id,
         'Grayhollow Village',
...
INSERT INTO Encounter
        (location_id, name, summary, read_aloud_text,
...
SET @poi1 := LAST_INSERT_ID();   -- first PoI id
/* monsters (wererats) */
